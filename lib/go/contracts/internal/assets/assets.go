...
// sources:
// ../../../contracts/CandyNFT.cdc (17.852kB)
...
func CandynftCdc() (*asset, error) {
	bytes, err := CandynftCdcBytes()
	if err != nil {
		return nil, err
	}

	info := bindataFileInfo{name: "CandyNFT.cdc", size: 0, mode: os.FileMode(0), modTime: time.Unix(0, 0)}
...
var _bintree = &bintree{nil, map[string]*bintree{
	"CandyNFT.cdc": {CandynftCdc, map[string]*bintree{}},
